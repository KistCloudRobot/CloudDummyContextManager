...
public class DummyRobotContextManagerAgent2 extends DummyContextManagerAgent {
	DataSource ds;

	RobotData rd = new RobotData();
	String robotID = "";

	public DummyRobotContextManagerAgent2(String brokerName, String brokerURL) {
...
//			new DummyRobotContextManagerAgent(brokerName, brokerURL);
			...
			Thread l2 = new Thread(new Runnable() {
				@Override
				public void run() {
					DummyRobotContextManagerAgent2 a = new DummyRobotContextManagerAgent2("Lift2", "tcp://"+ip+":61115");
