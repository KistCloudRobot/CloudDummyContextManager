...
public class DummyRobotContextManagerAgent3 extends DummyContextManagerAgent {
	DataSource ds;

	RobotData rd = new RobotData();
	String robotID = "";

	public DummyRobotContextManagerAgent3(String brokerName, String brokerURL) {
...
//			new DummyRobotContextManagerAgent(brokerName, brokerURL);
			...
			Thread t1 = new Thread(new Runnable() {
				@Override
				public void run() {
					DummyRobotContextManagerAgent3 a = new DummyRobotContextManagerAgent3("Tow1", "tcp://"+ip+":61114");
